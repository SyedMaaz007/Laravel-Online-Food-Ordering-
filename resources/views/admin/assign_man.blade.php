    ...
    <div class="col-md-12">
     <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          ...
          <div class="invoice-buttons text-left">  <label>Assign Delivery Man</label>
            <div class="input-group">
              <select class="form-control" name="delivery_id"  required>
                @foreach ($delivery as $list)
                    <option value="{{$list->delivery_id}}">
                    {{$list->delivery_name}}</option>
                @endforeach
              </select>
            </div>
            <div class="invoice-buttons text-right">
                <input type="submit" class="btn btn-primary" value="Assign Delivery Man">
              </div>
          </div>
          </form>
        </div>
