...
<body class="ms-body ms-primary-theme ms-has-quickbar ms-aside-left-open">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="{{url('dev_admin/dashboard')}}"> <span><i class="fa fa-briefcase fs-16"></i>Dashboard </span>
        </a>
      </li>


      <li class="menu-item">
        <a href="{{url('dev_admin/delivery/'.$delivery_id)}}"> <span><i class="fas fa-clipboard-list fs-16"></i>User Deatils</span>
        </a>
      </li>
    ...
    <nav class="navbar ms-navbar">
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        <li class="ms-nav-item ms-nav-user dropdown">
            <a class="media fs-14 p-2" href="{{url('dev_admin/logout')}}"> <span><i class="flaticon-shut-down mr-2"></i> Logout</span>
          </a>
