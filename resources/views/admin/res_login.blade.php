      ...
      <div class="ms-auth-container">
        <div class="ms-auth-col">
          <div class="ms-auth-form">
            <form action="{{route('res_auth')}}" method="post">
                @csrf
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" placeholder="Restauarant ID" name="name" required="">
                  <div class="invalid-feedback">Please provide Restauarant ID.</div>
                </div>
              </div>
              <div class="mb-2">
