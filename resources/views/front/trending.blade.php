...
<div class="cat-slider">
    ...
    <div class="cat-item px-1 py-3">
        <a class="bg-white rounded d-block p-2 text-center shadow-sm" href="{{url('food_catagory/'.$list->catagory_slug)}}">
    ...
    <div class="member-plan position-absolute"><span class="badge badge-dark">Trending</span></div>
